...
import './modalCreateCompanyDeal.css';

const modalCreateCompanyDeal = (props) => {

    return (
        <>
        {props.showModal ? (
            <div className="modal-background-new-company" onClick={(e) => e.target.classList.value === 'modal-background-new-company' && props.setShowModal(prev => !prev)}>
                <div className="modal-wrapper-new-company bg-custom-white">
                    <div className="d-flex flex-column h-100">
                        <div className="d-flex align-items-center custom-height-88 pl-4">
                            <h4><strong>Skapa nytt företagsavtal</strong></h4>
                        </div>
                        ...
                        <div className="mt-auto">
                            ...
                            <div className="d-flex justify-content-end align-items-center custom-height-60 pr-4">
                                <p className="text-primary btn"><strong>Skapa avtal</strong></p>
...
export default modalCreateCompanyDeal;