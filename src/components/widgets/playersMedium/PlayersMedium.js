...
const PlayersMediumWidget = (props) => {
        ...
        return (
            ...
            {player.booked ? (
                <div className="d-flex align-items-center m-auto py-2 px-1">
                    ...
                    {/*<p className="btn btn-font text-primary p-0 m-0" onClick={() => console.log('Gå till profil')}>Se profil</p>*/}
                    </div>
                </div>
                ) : (<></>)}
            </>
    ...
    return (
        <Col md={6} draggable>
            <div className="edit-widget-pop widget-rounded">
                <div className="bg-custom-blue custom-height-medium-widget widget-shadow widget-rounded w-100 m-auto py-4 px-4">
                    <div className="d-flex justify-content-between">
                        <h5> Spelar just nu </h5>
...
export default PlayersMediumWidget;